...
<head>
  ...
  <link href="resources/css/vendor/jquery-ui.css" rel="stylesheet" type="text/css"><!-- for slider-range -->
                  ...
                  <div class="header-navigation-content">
                    <div class="row">
                      <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="product-item">
                          <div class="pi-img-wrapper">
                            <a href="shop-item.html"><img src="resources/images/model4.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                          </div>
                      ...
                      <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="product-item">
                          <div class="pi-img-wrapper">
                            <a href="shop-item.html"><img src="resources/images/model3.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                          </div>
                          <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
                          <div class="pi-price">$29.00</div>
                          <a href="#" class="btn btn-default add2cart">Add to cart</a>
                      ...
                      <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="product-item">
                          <div class="pi-img-wrapper">
                            <a href="shop-item.html"><img src="resources/images/model7.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                          </div>
                          <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
                          <div class="pi-price">$29.00</div>
                          <a href="#" class="btn btn-default add2cart">Add to cart</a>
          ...
          <div class="col-md-9 col-sm-7">
            ...
            <div class="row product-list">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="resources/images/model1.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="resources/images/model1.jpg" class="btn btn-default fancybox-button">Zoom</a>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="resources/images/model2.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="resources/images/model2.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="resources/images/model6.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="resources/images/model6.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
            ...
            <div class="row product-list">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="resources/images/model4.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                        <a href="resources/images/model4.jpg" class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Berry Lace Dress Berry Lace Dress</a></h3>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="resources/images/model5.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                        <a href="resources/images/model5.jpg" class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="resources/images/model3.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                        <a href="resources/images/model3.jpg" class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
            ...
            <div class="row product-list">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="resources/images/model7.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                        <a href="resources/images/model7.jpg" class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
              ...
              <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-3">
                  <div class="product-main-image">
                    <img src="resources/images/model7.jpg" alt="Cool green dress with red bell" class="img-responsive">
                  </div>
                  <div class="product-other-images">
                    <a href="#" class="active"><img alt="Berry Lace Dress" src="resources/images/model3.jpg"></a>
                    <a href="#"><img alt="Berry Lace Dress" src="resources/images/model4.jpg"></a>
                    <a href="#"><img alt="Berry Lace Dress" src="resources/images/model5.jpg"></a>
                  </div>
                </div>
...
Nostrud duis molestie at dolore.</p>
    ...
    <script src="resources/js/vendor/jquery-migrate.min.js" type="text/javascript"></script>
    ...
    <script src="resources/js/vendor/jquery.slimscroll.min.js" type="text/javascript"></script>
    <!-- END CORE PLUGINS -->

    <!-- BEGIN PAGE LEVEL JAVASCRIPTS (REQUIRED ONLY FOR CURRENT PAGE) -->
    <script src="resources/js/vendor/jquery.fancybox.pack.js" type="text/javascript"></script><!-- pop up -->
    <script src="resources/js/owl.carousel.min.js" type="text/javascript"></script><!-- slider for products -->
    <script src='resources/js/vendor/jquery.zoom.min.js' type="text/javascript"></script><!-- product zoom -->
    <script src="resources/js/vendor/bootstrap.touchspin.js" type="text/javascript"></script><!-- Quantity -->
<!--     <script src="resources/js/vendor/jquery.uniform.min.js" type="text/javascript"></script> -->
    <script src="resources/js/vendor/jquery.rateit.js" type="text/javascript"></script>
    <script src="resources/js/vendor/jquery-ui.js" type="text/javascript"></script><!-- for slider-range -->
