...
<link href="resources/css/uniform.default.css" rel="stylesheet"
	type="text/css">
<link href="resources/css/vendor/jquery-ui.css" rel="stylesheet"
	type="text/css">
<!-- for slider-range -->
...
<body class="ecommerce">
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 additional-nav">
					<ul class="list-unstyled list-inline pull-right">
						...
						<li><a href="#login-popup" class="fancybox-fast-view">Log In</a></li>
					</ul>
				</div>
				<!-- END TOP BAR MENU -->
			</div>
			...
			<div class="header-navigation">
				<ul>
					<li class="dropdown">
						...
						<!--                     <li><a href="shop-product-list.html">Second Level Link</a></li> -->
						<!--                     <li class="dropdown-submenu"> --> <!--                       <a class="dropdown-toggle" data-toggle="dropdown" data-target="#" href="#"> -->
						...
						<!--                         <li><a href="shop-product-list.html">Third Level Link</a></li> -->
						<!--                       </ul> --> <!--                     </li> -->
						<!--                   </ul> --> <!--                 </li> --> <!--                 <li><a href="shop-product-list.html">Running Shoes</a></li> -->
	...
	<!-- END FOOTER -->
	<div id="login-popup" style="display: none; width: 700px;">
		<div class="col-md-9 col-sm-9 login-popup">
		<h1>Login</h1>
